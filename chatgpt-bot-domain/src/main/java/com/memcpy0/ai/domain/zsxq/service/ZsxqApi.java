package com.memcpy0.ai.domain.zsxq.service;
...
import com.memcpy0.ai.domain.zsxq.model.req.AnswerReq;
import com.memcpy0.ai.domain.zsxq.model.req.ReqData;
import com.memcpy0.ai.domain.zsxq.model.res.AnswerRes;
...
public class ZsxqApi implements IZsxqApi {
    ...
    public boolean answer(String groupId, String cookie, String topicId, String text, boolean silenced) throws IOException {
        ...
        AnswerReq answerReq = new AnswerReq(new ReqData(text, silenced)); // 包装答案为请求
        String paramJson = JSONObject.toJSONString(answerReq); // 发送JSON字符串
        ...
        if (response.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
            ...
            return answerRes.isSucceeded(); // 知道是否成功
        } else {
